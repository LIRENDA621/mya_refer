...
body_weight_dir=/NAS5/speech/user/ziyichen/paii_mya/checkpoints/finetune_xinlu3/checkpoint-30000
head_weight_dir=/NAS5/speech/user/ziyichen/paii_mya/checkpoints/finetune_xinlu3/head/checkpoint-30000
...
body_input_dir=/NAS5/speech/user/ziyichen/paii_mya/test_data/xinlu3/VID20240719162555

# path to the reference body appearance
body_prompt_img_pth=/NAS5/speech/data/virtual_being/paii/yuxinlu698/010/norm/VID20240717140840_crop_1080_1080_0_350_resize_512x512/clips/000004/images/000001.png
# path to the reference head appearance
head_prompt_img_pth=/NAS5/speech/data/virtual_being/paii/yuxinlu698/010/norm/VID20240717140840_crop_1080_1080_0_350_resize_512x512/clips/000004/raw_aligned/000001.png
...
save_root=./outputs/xinlu3/VID20240719162643
...
# ffmpeg -r 30 -i $body_input_dir/%06d.png -q:v 0 -pix_fmt yuv420p ${body_save_dir}_mesh.mp4
# ffmpeg -i $body_save_dir.mp4 -i ${body_save_dir}_mesh.mp4 -filter_complex hstack=inputs=2 ${body_save_dir}_comb.mp4
# exit 0
# # face alignment
