...
body_weight_dir=/NAS5/speech/models/multimodal/virtual_being/paii_mya/xly/body
# path to the input poses
pose_name=test20

# pose_name=random_gesture_same_pose
# pose_name=hand_gesture

body_input_dir=/NAS5/speech/models/multimodal/virtual_being/paii_mya/xly/poses/$pose_name
# path to the reference body appearance
body_prompt_img_pth=/NAS5/speech/models/multimodal/virtual_being/paii_mya/xly/appearance/body.png
...
save_root=./outputs/xly/$pose_name
