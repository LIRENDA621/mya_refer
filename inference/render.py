...
from pytorch3d.io import load_obj, load_ply, load_objs_as_meshes, load_texture_from_image
...
Tr = np.load("/NAS5/speech/data/multimodal/virtual_being/ECCV/UV_training_3_actors/camera_transl/all_transl_SHOW_seth.npy")
# Tr = np.load(f'./data/{idx}-SHOW1/all_transl_SHOW_{idx}.npy',)
...
blend = BlendParams(background_color=(255.0, 255.0, 255.0))
...
files_meshes = glob.glob(f'/NAS5/speech/data/multimodal/virtual_being/ECCV/talkshow/seth/98835-00_00_01-00_00_11/mesh/*.obj')
files_meshes = sorted(
...
# path = f'./checkpoints/show-{idx}-upper-hands-uv-texture-fitting-nogloss-256'
verts, faces, aux = load_obj('/NAS5/speech/user/ziyichen/Make-Your-Anchor/inference/smplx_uv/smplx_uv.obj')
verts_uvs = aux.verts_uvs[None, ...].to(device)  # (1, V, 2)
faces_uvs = faces.textures_idx[None, ...].to(device)  # (1, F, 3)
texture_image = cv2.imread("/NAS5/speech/user/ziyichen/Make-Your-Anchor/inference/smplx_uv/smplx_uv.png")
...
save_folder = f'meshes/texture_meshes'
...
# texture_image = torch.full([1, res, res, 3], 0.5, device=device, requires_grad=True)
# save_folder = f'./data/{idx}-SHOW1/audio2mesh/audio{audio_id}/untexture_meshes'
# # save_folder = f'./data/{idx}-SHOW1/audio2mesh/audio1/texture_meshes'
# print(save_folder)
# os.makedirs(save_folder, exist_ok=True)
# cnt = 0
...
# save_folder_depth = './data/john-oliver-SHOW1/JO_SHOW1/depths'
# save_folder_normals = './data/john-oliver-SHOW1/JO_SHOW1/normals'
